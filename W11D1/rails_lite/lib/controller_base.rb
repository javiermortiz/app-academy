...
class ControllerBase
  ...
  def render(template_name)
    current_dir = File.dirname(__FILE__)  # users/app_academy/rails_project/views/users_controller/index
    controller_name = self.class.name.underscore  # UsersControler => users_controller
